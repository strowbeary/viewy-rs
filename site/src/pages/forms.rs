...
pub fn forms() -> VStack {
    ...
    stack
        ...
        .append_child(showcase_section("Multiple file input", {
            let mut vstack = VStack::new(Alignment::Stretch);
            vstack
                .gap(vec![scale(4)])
                .append_child(
                    Form::new("mfile-hidden-form", "/upload-file")
                        ...
                        .append_child(MultipleFileInput::new(
                            "mfile-hidden",
        ...
        .append_child(showcase_section("Multiple value text field", {
            let mut vstack = VStack::new(Alignment::Stretch);
            vstack
                .gap(vec![scale(4)])
                .append_child(
                    Field::new("multivalue", FieldType::Email)
                        ...
                        .multiple_value(vec!["dev@remicaillot.fr".to_string()]),
                )
                .append_child(Button::new("Open popup", ButtonStyle::Filled).popup({
        ...
        .append_child(
            VStack::new(Alignment::Stretch)
                ...
                .append_child(Text::new(
                    "Submit on keypress in Field component",
                    TextStyle::H1,
                ))
                .append_child(
