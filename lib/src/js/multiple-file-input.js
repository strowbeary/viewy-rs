window.addEventListener("startViewy", ({detail}) => {
    ...
    detail.root.querySelectorAll(".multiple-file-input")
        .forEach(fileInputComponent => {
            ...
            file_list.querySelector(".multiple-file-input--hidden__file-list__control-bar__close-button").addEventListener("click", (e) => {
                file_list.style.display = "none";
            })
            let file_list_content = file_list.querySelector(".multiple-file-input__file-list__content");
