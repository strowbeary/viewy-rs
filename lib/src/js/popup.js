function closeAllPopover() {
    ...
    window.addEventListener("startViewy", ({detail}) => {
        ...
        function open(popupId) {
            ...
            popup.querySelectorAll("[data-is-old-iframe]").forEach((oldIframe) => {
                oldIframe.tagName = "iframe";
                iframe.removeAttribute("data-is-old-iframe");
            });
        ...
        function close(popupId) {
            ...
            popup.querySelectorAll("iframe").forEach((iframe) => {
                iframe.tagName = "div";
                iframe.setAttribute("data-is-old-iframe", "data-is-old-iframe");
            });
        }
        ...
        function init() {
            popups.forEach(popup => {
                ...
                el.querySelectorAll("a, .button, .clickable, .file-input")
                    .forEach(clickable => {
